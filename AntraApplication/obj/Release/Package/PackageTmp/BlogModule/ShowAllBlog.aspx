                        ...
                        <asp:GridView ID="grdBlog" runat="server" CssClass="table table-bordered table-hover table-striped" GridLines="None"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Image">
                                    <ItemTemplate>
                                        <asp:Image runat="server" ID="img" Width="100" Height="100" AlternateText="No Image" Visible='<%# !(Eval("ImagePath") is DBNull) %>' ImageUrl='<%# ConfigurationManager.AppSettings["ImageUrlB"]  + "\\" +  DataBinder.Eval(Container.DataItem, "ImagePath") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>

...
var ytEmbed = {
            ...
            for (var i = 0; i < json.items.length; i++) {
                ...
                if (this.cfg.layout == 'thumbnails') {
                   // li.className = 'small';
                    ...
                    //this.cfg.layout = full
                    li.innerHTML = '<table><tr><td valign="top" rowspan="2" width="80px"></td><td valign="top"  width="120px"><h4>' + entry.snippet.title + '</h4></td></tr></table>';
    ...
    createPlayer: function (cfg) {
        window.open('http://www.youtube.com/embed/' + ytPlayerParams.videoId + '?autoplay=' + ytPlayerParams.autoplay + '&modestbranding=1', '_blank');
        return false;
